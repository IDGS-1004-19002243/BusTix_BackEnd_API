...
namespace prjBusTix.Migrations
{
    ...
    [Migration("20251124200414_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("prjBusTix.Model.EstadoParadaViaje", b =>
                {
                    b.Property<int>("EstadoParadaViajeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EstadoParadaViajeID"));

                    b.Property<string>("ConfirmadoPorChofer")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateTime?>("FechaHoraFinalizacionValidacion")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FechaHoraInicioValidacion")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FechaHoraLlegadaChofer")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("LatitudConfirmacion")
                        .HasColumnType("decimal(10,8)");

                    b.Property<decimal?>("LongitudConfirmacion")
                    ...
                    b.Property<int>("TotalPasajerosAbordados")
                        .HasColumnType("int");

                    b.Property<int>("TotalPasajerosEsperados")
                        .HasColumnType("int");

                    b.Property<int>("TotalPasajerosNoShow")
                        .HasColumnType("int");

                    b.Property<bool>("TuvoIncidencia")
                        .HasColumnType("bit");

                    b.Property<string>("ValidadoPorStaff")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("EstadoParadaViajeID");

                    b.HasIndex("ConfirmadoPorChofer");

                    b.HasIndex("Estado");

                    b.HasIndex("ParadaViajeID");

                    b.HasIndex("ValidadoPorStaff");

                    b.HasIndex("ViajeID", "ParadaViajeID")
                        .IsUnique();

                    b.ToTable("EstadoParadaViaje");
                });
            ...
            modelBuilder.Entity("prjBusTix.Model.PrecioParada", b =>
                {
                    b.Property<int>("PrecioParadaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PrecioParadaID"));
            ...
            modelBuilder.Entity("prjBusTix.Model.EstadoParadaViaje", b =>
                {
                    b.HasOne("prjBusTix.Model.ClApplicationUser", "Chofer")
                        .WithMany()
                        .HasForeignKey("ConfirmadoPorChofer")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("prjBusTix.Model.ParadaViaje", "ParadaViaje")
                        .WithMany()
                        .HasForeignKey("ParadaViajeID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("prjBusTix.Model.ClApplicationUser", "Staff")
                        .WithMany()
                        .HasForeignKey("ValidadoPorStaff")
                        .OnDelete(DeleteBehavior.Restrict);
